...
import EquipoForm from '../components/EquipoForm.jsx'; // <-- Importa el formulario
...
import { createEquipo } from '@services/equipos.service.js'; // <-- Importa el servicio
      ...
      <div className='table-container'>
        <div className='top-table'>
          ...
          <div className='filter-actions'>
            ...
            <button onClick={handleOpenForm}>Ingresar nuevo equipo</button>
